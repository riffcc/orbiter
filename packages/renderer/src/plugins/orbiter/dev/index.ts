import { RELEASES_AUTHOR_COLUMN, RELEASES_FILE_COLUMN, RELEASES_METADATA_COLUMN, RELEASES_NAME_COLUMN, RELEASES_THUMBNAIL_COLUMN, RELEASES_TYPE_COLUMN } from '../consts';
...
export const loadStubData = async (app: Orbiter) => {
    ...
    const audioFile = (await import('../../../../../../tests/devData/06-yy_ch01_l01_d01.mp3')).default;
    console.log({audioFile});
    const audioCid = await app.constellation.ajouterÀSFIP({
        fichier: audioFile,
    });

    const thumbnailFile = (await import('../../../../../../tests/devData/thumbnail.svg')).default;
    ...
    await app.addRelease({
        ...
        [RELEASES_THUMBNAIL_COLUMN]: {cid: thumbnailCid, ext: 'mp3'},
